...
<div id="hd">
    ...
    <div id="hd_menu">
        <ul>
            <li><a href="<?php echo G5_SHOP_URL; ?>/listtype.php?type=1">추천</a></li>
            <li><a href="<?php echo G5_SHOP_URL; ?>/listtype.php?type=2">관광</a></li>
            <li><a href="<?php echo G5_SHOP_URL; ?>/listtype.php?type=3">맛집</a></li>
            <li><a href="<?php echo G5_SHOP_URL; ?>/listtype.php?type=4">숙소</a></li>
